...
<body >
	...
	<form style="background: url(/CabinetMS/static/cabinet/images/login_kuang.jpg);background-size: cover" id="loginForm" class="form-signin" action="${ctx}/login" method="post">
